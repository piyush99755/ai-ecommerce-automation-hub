...
export type StorageHash =
  StorageHashBase<'69952d2523cc86e0ea99463895c9f6ddd46d3978917bd3592c8ec566d7f0ccac'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Admin: {
      ...
      readonly role: 'SUPER_ADMIN' | 'OPERATIONS' | 'SUPPORT';
        ...
        readonly entries: {
          readonly table: {
              ...
              columns: {
                ...
                readonly role: {
                  ...
                  readonly default: {
                    ...
                    readonly value: DefaultLiteralValue<'pg/text@1', 'SUPER_ADMIN'>;
                  };
                };
                readonly createdAt: {
            ...
            readonly adminAuditLog: {
              ...
              indexes: readonly [
                {
                  readonly name: 'adminAuditLog_adminId_createdAt_idx_5015ed56';
                  readonly prefix: 'adminAuditLog_adminId_createdAt_idx';
                  readonly columns: readonly ['adminId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'adminAuditLog_entityType_entityId_createdAt_idx_e9eb579f';
                  readonly prefix: 'adminAuditLog_entityType_entityId_createdAt_idx';
                  readonly columns: readonly ['entityType', 'entityId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'adminAuditLog_action_createdAt_idx_a6d20b4b';
                  readonly prefix: 'adminAuditLog_action_createdAt_idx';
                  readonly columns: readonly ['action', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'adminAuditLog_adminId_idx_530179db';
                  readonly prefix: 'adminAuditLog_adminId_idx';
            ...
            readonly copilotAction: {
              ...
              indexes: readonly [
                {
                  readonly name: 'copilotAction_adminId_createdAt_idx_5015ed56';
                  readonly prefix: 'copilotAction_adminId_createdAt_idx';
                  readonly columns: readonly ['adminId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'copilotAction_status_expiresAt_idx_c206f415';
                  readonly prefix: 'copilotAction_status_expiresAt_idx';
                  readonly columns: readonly ['status', 'expiresAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'copilotAction_adminId_idx_530179db';
                  readonly prefix: 'copilotAction_adminId_idx';
                  readonly columns: readonly ['adminId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'copilotAction';
                    readonly columns: readonly ['adminId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            readonly AdminRole: {
              ...
              readonly values: readonly ['SUPER_ADMIN', 'OPERATIONS', 'SUPPORT'];
            };
